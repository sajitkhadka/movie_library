        ...
        <!-- First Container -->
         <div class="d-flex justify-content-center">
            ...
            <div class="container color-primary text-center padding-top-50">
              <div class="d-flex justify-content-center">
                  <a href="add-shows" type="button" class="btn btn-outline-secondary">Add New Show</a>
              </div>    
                  ...
                  <table class="table">
                    ...
                    <tbody>
                         <c:forEach var="show" items="${shows}">
                              <tr>
                                 <th scope="row">${show.showsId}</th>
                                 <td>${show.title}</td>
                                   <form name='edit' method="POST" action="shows">
                                 <td>
                                                                          
                                         <input type="hidden" value=${show.showsId} name="id">
